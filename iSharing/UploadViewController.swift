...
class UploadViewController: UIViewController,UIImagePickerControllerDelegate,UINavigationControllerDelegate, URLSessionTaskDelegate, URLSessionDataDelegate {
    ...
    @IBAction func selectFromAlbum(_ sender: Any) {
    ...
    func imagePickerController(_ picker: UIImagePickerController, didFinishPickingMediaWithInfo info: [String : Any]) {
        ...
        if(fileManager.fileExists(atPath: filePath)){
            ...
            //            let uploadURL:String = "http://ec2-52-87-151-146.compute-1.amazonaws.com:8080/s3/upload"
                        let uploadURL:String = "http://34.224.72.166:8080/s3/upload"
